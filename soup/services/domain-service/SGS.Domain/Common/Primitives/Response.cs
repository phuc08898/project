...
public class ErrorResponse(string msg, ErrorCodes errorCode) :
    BaseResponse(msg, errorCode)
{
...
public class OkResponse(string msg = "Ok.") : BaseResponse(msg, ErrorCodes.NoContent)
{
}
